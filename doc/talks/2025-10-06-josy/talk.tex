...
\begin{frame}
	...
	\texttt{garagehq@deuxfleurs.fr}

	Matrix channel: \texttt{\#garage:deuxfleurs.fr}
\end{frame}

\begin{frame}
	\frametitle{Garage is a non-profit initiative}
...
\begin{frame}
	\frametitle{Who may offer commercial support for Garage?}
	\begin{columns}[t]
		\begin{column}{.2\textwidth}
			\centering
